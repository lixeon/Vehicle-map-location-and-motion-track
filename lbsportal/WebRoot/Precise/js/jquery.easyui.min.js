...
var tabs=$(_2e9).children("div.tabs-header").find("ul.tabs"/*tpa=http://www.beidouguard.com:6010/Precise/js/ul.tabs*/);
...
$(document).unbind(".menu").bind("mousedown.menu"/*tpa=http://www.beidouguard.com:6010/Precise/js/mousedown.menu*/,function(e){
var _377=$("body>div.menu:visible");
var m=$(e.target).closest("div.menu"/*tpa=http://www.beidouguard.com:6010/Precise/js/div.menu*/,_377);
if(m.length){
return;
}
...
menu.unbind(".menu").bind("mouseenter.menu"/*tpa=http://www.beidouguard.com:6010/Precise/js/mouseenter.menu*/,function(){
if(_386.timer){
clearTimeout(_386.timer);
_386.timer=null;
}
}).bind("mouseleave.menu"/*tpa=http://www.beidouguard.com:6010/Precise/js/mouseleave.menu*/,function(){
...
item.unbind(".menu");
item.bind("click.menu"/*tpa=http://www.beidouguard.com:6010/Precise/js/click.menu*/,function(){
...
}).bind("mouseenter.menu"/*tpa=http://www.beidouguard.com:6010/Precise/js/mouseenter.menu*/,function(e){
...
}).bind("mouseleave.menu"/*tpa=http://www.beidouguard.com:6010/Precise/js/mouseleave.menu*/,function(e){
...
var form=$(_422);
form.unbind(".form").bind("submit.form"/*tpa=http://www.beidouguard.com:6010/Precise/js/submit.form*/,function(){
setTimeout(function(){
_40f(_422,_423);
},0);
return false;
