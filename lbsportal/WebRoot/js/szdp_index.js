...
var Index = {
    ...
    icons: {
        ...
        zoom12_18: {//电动车12-18级地图
            accon: new BMap.Icon('images/L3_32x32_ACCOn_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/L3_32x32_ACCOn_Online.png*/, new BMap.Size(32, 32)),
            accoff: new BMap.Icon('images/L3_32x32_ACCOff_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/L3_32x32_ACCOff_Online.png*/, new BMap.Size(32, 32)),
            move: new BMap.Icon('images/L3_32x32_ACCOff_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/L3_32x32_ACCOff_Online.png*/, new BMap.Size(32, 32)),
            offline: new BMap.Icon('images/L3_32x32_ACCOff_Offline.png'/*tpa=http://www.beidouguard.com:6010/js/images/L3_32x32_ACCOff_Offline.png*/, new BMap.Size(32, 32)),
            alarm: new BMap.Icon('images/alarm.gif'/*tpa=http://www.beidouguard.com:6010/js/images/alarm.gif*/, new BMap.Size(30, 24))
        },
        Motorzoom12_18: {//摩托车12-18级地图
            accon: new BMap.Icon('images/Motor_32x32_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/Motor_32x32_Online.png*/, new BMap.Size(32, 32)),
            accoff: new BMap.Icon('images/Motor_32x32_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/Motor_32x32_Online.png*/, new BMap.Size(32, 32)),
            move: new BMap.Icon('images/Motor_32x32_Online2.png'/*tpa=http://www.beidouguard.com:6010/js/images/Motor_32x32_Online2.png*/, new BMap.Size(32, 32)),
            offline: new BMap.Icon('images/Motor_32x32_Offline.png'/*tpa=http://www.beidouguard.com:6010/js/images/Motor_32x32_Offline.png*/, new BMap.Size(32, 32)),
            alarm: new BMap.Icon('images/alarm.gif'/*tpa=http://www.beidouguard.com:6010/js/images/alarm.gif*/, new BMap.Size(30, 24))
        },
        ...
        JCzoom12_18: {//警车12-18级地图
            accon: new BMap.Icon('images/JC_32x32_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/JC_32x32_Online.png*/, new BMap.Size(32, 32)),
            accoff: new BMap.Icon('images/JC_32x32_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/JC_32x32_Online.png*/, new BMap.Size(32, 32)),
            move: new BMap.Icon('images/JC_32x32_Online2.png'/*tpa=http://www.beidouguard.com:6010/js/images/JC_32x32_Online2.png*/, new BMap.Size(32, 32)),
            offline: new BMap.Icon('images/JC_32x32_Offline.png'/*tpa=http://www.beidouguard.com:6010/js/images/JC_32x32_Offline.png*/, new BMap.Size(32, 32)),
            alarm: new BMap.Icon('images/alarm.gif'/*tpa=http://www.beidouguard.com:6010/js/images/alarm.gif*/, new BMap.Size(30, 24))
        },
        TLJzoom12_18: {//拖拉机12-18级地图
            accon: new BMap.Icon('images/TLJ_32x32_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/TLJ_32x32_Online.png*/, new BMap.Size(32, 32)),
            accoff: new BMap.Icon('images/TLJ_32x32_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/TLJ_32x32_Online.png*/, new BMap.Size(32, 32)),
            move: new BMap.Icon('images/TLJ_32x32_Online2.png'/*tpa=http://www.beidouguard.com:6010/js/images/TLJ_32x32_Online2.png*/, new BMap.Size(32, 32)),
            offline: new BMap.Icon('images/TLJ_32x32_Offline.png'/*tpa=http://www.beidouguard.com:6010/js/images/TLJ_32x32_Offline.png*/, new BMap.Size(32, 32)),
            alarm: new BMap.Icon('images/alarm.gif'/*tpa=http://www.beidouguard.com:6010/js/images/alarm.gif*/, new BMap.Size(30, 24))
        },
        WJJzoom12_18: {//挖掘机车12-18级地图
            accon: new BMap.Icon('images/WJJ_32x32_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/WJJ_32x32_Online.png*/, new BMap.Size(32, 32)),
            accoff: new BMap.Icon('images/WJJ_32x32_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/WJJ_32x32_Online.png*/, new BMap.Size(32, 32)),
            move: new BMap.Icon('images/WJJ_32x32_Online2.png'/*tpa=http://www.beidouguard.com:6010/js/images/WJJ_32x32_Online2.png*/, new BMap.Size(32, 32)),
            offline: new BMap.Icon('images/WJJ_32x32_Offline.png'/*tpa=http://www.beidouguard.com:6010/js/images/WJJ_32x32_Offline.png*/, new BMap.Size(32, 32)),
            alarm: new BMap.Icon('images/alarm.gif'/*tpa=http://www.beidouguard.com:6010/js/images/alarm.gif*/, new BMap.Size(30, 24))
        },
        SGJzoom12_18: {//收割机车12-18级地图
            accon: new BMap.Icon('images/SGJ_32x32_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/SGJ_32x32_Online.png*/, new BMap.Size(32, 32)),
            accoff: new BMap.Icon('images/SGJ_32x32_Online.png'/*tpa=http://www.beidouguard.com:6010/js/images/SGJ_32x32_Online.png*/, new BMap.Size(32, 32)),
            move: new BMap.Icon('images/SGJ_32x32_Onlin2.png'/*tpa=http://www.beidouguard.com:6010/js/images/SGJ_32x32_Onlin2.png*/, new BMap.Size(32, 32)),
            offline: new BMap.Icon('images/SGJ_32x32_Offline.png'/*tpa=http://www.beidouguard.com:6010/js/images/SGJ_32x32_Offline.png*/, new BMap.Size(32, 32)),
            alarm: new BMap.Icon('images/alarm.gif'/*tpa=http://www.beidouguard.com:6010/js/images/alarm.gif*/, new BMap.Size(30, 24))
        }
    },
...
//        }, serverInfo.configParam.popupInterval);
    ...
    trackMonitoring: function () {
        if (window.temp == 1) {
            setInterval("Index.trackMonitoringcirculatemethod()", 60000);
            window.temp = 0;
        }
        else {
    ...
    trackMonitoringcirculatemethod: function () {
        var date = new Date();
        var year = date.getFullYear();
        var month = date.getMonth() + 1;
        var day = date.getDate();
        ...
        if (window.olddate == "") {
            window.olddate = datetime;
        }
        var trace_starttime = window.olddate;
        var trace_endtime = datetime;
        if (trace_starttime != trace_endtime) {
            $.ajax({
                url: 'actions/get_trace.ashx?num=' + 0 + "&trace_starttime=" + trace_starttime + "&trace_endtime=" + trace_endtime + "&mapSource=baidu",  
                type: 'post',
                error: function () { },
                success: function (data) {
                    var onearr = data.split('#');
                    for (var r = 0; r < onearr.length; r++) {
                        var arr = onearr[r].split(',');
                        //pts = [];
                        if (arr.length > 4) {
                            Index.pts = [];
                    ...
                    pauseTime = 1;
                            ...
                            Index.tracePly.addEventListener("click", Index.attribute);
                            baiduMap.addOverlay(Index.tracePly);
                            baiduMap.setViewport(Index.tracePly.getPath());

                            var spd = mini.get('velocityList').getValue();
                            Index.traceMgr._opts.speed = 80000;
                            Index.traceMgr.start();
                        }
                    }
                }
    ...
    attribute: function () {
        Index.tracePly.setStrokeColor("#ADFF2F");
    },
    //停止小车动画
    bikePause: function () {
        var a = $('#TrackRun').html();
